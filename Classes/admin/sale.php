...
<?php
    class sale
    {
        ...
        public function insert_sale($saleName, $description, $discount)
        {
            ...
            {
                $query = "INSERT INTO `sale`(NameSale, Descrip, Percent, DateStart) VALUES ('$saleName', '$description', '$discount', '$time')";
        ...
        public function update_sale($nameSale, $discount, $description, $id)
        {
            ...
            {
                $query = "UPDATE `sale` SET NameSale='$nameSale', Descrip='$description', Percent='$discount', DateStart='$time' WHERE IdSale = '$id' ";
